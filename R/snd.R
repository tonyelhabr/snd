...
#' @importFrom purrr safely map map2 keep map_dfr flatten_chr
#' @importFrom tidyr unnest_wider fill crossing
#' @importFrom stats as.formula coefficients loess plogis predict binomial
